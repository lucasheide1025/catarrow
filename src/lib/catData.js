...
export const CAT_TYPES = {
  attack: {
    ...
    skills: [
      ...
      { bond: 50,  name: "連環撲擊",  desc: "10% 機率連續觸發兩次傷害" },
      { bond: 150, name: "全力一擊",  desc: "5% 機率本箭傷害 ×3" },
    ],
    color: "#ef4444",
  },
  defense: {
    ...
    skills: [
      ...
      { bond: 50,  name: "療傷舔傷",  desc: "10% 機率回復 HP +50" },
      { bond: 150, name: "生命連結",  desc: "5% 機率完全免疫本次 Boss 反擊" },
    ],
    color: "#3b82f6",
  },
  allround: {
    ...
    skills: [
      ...
      { bond: 50,  name: "金幣嗅覺",  desc: "10% 機率金幣獎勵 +20%" },
      { bond: 150, name: "全場加持",  desc: "5% 機率全屬性 +15% 持續一回合" },
    ],
    color: "#f59e0b",
  },
};
