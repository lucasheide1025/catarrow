...
export const GENERAL_EVENTS = [
  ...
  { id:"g_box2",       icon:"🎁", title:"破木箱",       desc:"路邊一個破木箱，撬開發現一瓶藥水 → 每人獲得回復藥", effect:{ item:"carry_heal_basic" } },
  ...
  { id:"g_potiondrop", icon:"🧪", title:"滾來的藥水",   desc:"一瓶藥水從斜坡滾到腳邊 → 每人獲得回復藥", effect:{ item:"carry_heal_basic" } },
...
export const SPECIAL_EVENTS = [
  ...
  { id:"s_fishing", icon:"🎣", title:"深潭釣魚", desc:"黑水潭裡似乎有東西在動。",
    choices:[
      { label:"花 50 金下竿", cost:{ gold:50 }, effect:{ random:[{ gold:60 }, { hp:0.10 }, {}] }, hint:"隨機：+60 金幣／回復 10% HP／空鉤" },
      { label:"不釣，走人", effect:{} },
    ] },
  { id:"s_ratcasino", icon:"🐭", title:"老鼠賭場", desc:"幾隻老鼠開了個小賭局，邀你下注下一場戰鬥。",
    choices:[
      { label:"押注（賭金幣）", effect:{ random:[{ gold:40 }, { gold:-20 }] }, hint:"立即擲定：贏得 40 金幣／損失 20 金幣" },
      { label:"不賭", effect:{} },
    ] },
  ...
  { id:"s_altarfast", icon:"🕯️", title:"禁食祭壇", desc:"祭壇要求你放棄一頓飯。",
    choices:[
      { label:"強行趕路", effect:{ atk:0.10, hp:-0.05 }, hint:"本層 ATK +10%，立即損失 5% HP" },
      { label:"拒絕", effect:{} },
    ] },
