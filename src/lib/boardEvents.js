...
export const FATE_EVENTS = [
  ...
  { id: "f06", deck: "fate", flavor: false, text: "霧徑幻姬扭轉道路，繞了老半天又退回原地。", effect: { type: "move", steps: -4 } },
  { id: "f07", deck: "fate", flavor: false, text: "幽城女判嘉許你的善行，賞你一袋金幣。", effect: { type: "gain", resource: "coins", min: 200, max: 500 } },
  { id: "f08", deck: "fate", flavor: false, text: "林投守姬贈你幾片護葉，化成了可用素材。", effect: { type: "gain", resource: "material", min: 3, max: 5 } },
  { id: "f09", deck: "fate", flavor: false, text: "海誓靈姬的鈴聲引路，帶你飛奔向前。", effect: { type: "move", steps: 2 } },
  ...
  { id: "f26", deck: "fate", flavor: false, text: "遇上巡行的鏡幕幽姬，比劃一場！", effect: { type: "trigger", event: "monster" } },
  ...
  { id: "f32", deck: "fate", flavor: false, text: "【組隊】鏡幕幽姬為全隊映出捷徑，一起前進！", effect: { type: "team", sub: "allMove", steps: 2 } },
