...
export default function HonorTicker({ memberId, onGoPage }) {
  ...
  return (
    <button onClick={() => onGoPage && onGoPage("notifications")}
      ...
      <span className="text-base flex-shrink-0" style={isLatest ? { animation: "tickerPulse 1.2s ease infinite" } : {}}>
