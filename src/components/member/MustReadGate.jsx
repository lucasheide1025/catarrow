...
// 強制閱讀彈窗：有未讀的優惠(promo, mustRead)時，覆蓋全螢幕，讀了才能繼續
import { useState, useEffect } from "react";
import { subscribeNotifications, markNotificationRead } from "../../lib/db";

export default function MustReadGate({ memberId }) {
  const [queue, setQueue] = useState([]);   // 未讀的強制訊息
  ...
  async function confirm() {
    ...
    // 標記後 subscribe 會更新 queue，自動換下一則或關閉
  }
