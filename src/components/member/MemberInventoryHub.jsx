      ...
      <div className="mt-2 border-t border-white/10 pt-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="col-span-2">
            <HubTile title="專精與符文" desc="戰鬥流派・符文製作" image={progressionImage}
              accent="#8b5cf6" onClick={() => onPageChange("specialization-runes")} />
          </div>
          <HubTile title="我的裝備" desc="穿戴・強化・外觀" image={equipmentImage}
            accent="#64748b" onClick={() => onPageChange("equipment")} />
          <HubTile title="怪物卡片" desc="收藏・升星・加成" image={cardsImage}
