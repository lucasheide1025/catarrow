...
export function settleExpedition(state, opts = {}) {
  ...
  return {
    ...
    luck: {
      luk: state.guildStats?.luk || 0,
      dropBonusPct: Math.round((d.dropBonusPct || 0) * 100),
      valuationBonusPct: Math.round((d.valuationBonusPct || 0) * 100),
      critChancePct: Math.round((d.critChance || 0) * 100),
    },
  };
}
