...
const NAV_PRELOADS = {
  ...
  "inventory-hub": () => {
    ...
    import("../components/member/CardCollectionModern");
    ...
    <div style={{ height:"100dvh", display:"flex", flexDirection:"column", fontFamily:"sans-serif", overflow:"hidden", background:"#0f172a" }}>
      ...
      {dungeonKillAlert && (
        <div role="button" tabIndex={0} aria-live="polite"
          style={{ position:"fixed", top:0, left:0, right:0, zIndex:999, padding:"12px 16px", background: dungeonKillAlert.kind === "villageGoal" ? "linear-gradient(90deg,#14532d,#166534,#14532d)" : "linear-gradient(90deg,#78350f,#92400e,#78350f)", boxShadow:"0 4px 24px rgba(0,0,0,0.5)", display:"flex", alignItems:"center", gap:12, cursor:"pointer" }}
