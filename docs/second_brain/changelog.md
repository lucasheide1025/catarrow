...
- **新 `ui/GuildLicense.jsx`（冒險者證）**：階級徽章＋配戴稱號＋聲望條、6 格戰績（遠征勝/總、☠️×3+、☠️×6、雜貨圖鑑、最高強化、稱號數）、**📋 複製戰績**（純文字貼給隊友，不做圖片產生器）、稱號分類清單（未解鎖顯示灰底＋進度條）、**雜貨圖鑑分頁**（72 格，未發現顯示 ❓ 灰底，已發現顯示圖示/稀有度/撿過幾次）。
