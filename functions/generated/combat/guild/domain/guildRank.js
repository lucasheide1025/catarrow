...
exports.GUILD_RANKS = void 0;
exports.canAcceptDanger = canAcceptDanger;
exports.nextRankInfo = nextRankInfo;
exports.rankIndexOf = rankIndexOf;
exports.rankUnlocks = rankUnlocks;
exports.repNeededForDanger = repNeededForDanger;
exports.repToRank = repToRank;
...
const GUILD_RANKS = exports.GUILD_RANKS = Object.freeze([
...
function rankIndexOf(rankId = "apprentice") {
...
// 這個階級解鎖了什麼
function rankUnlocks(input = 0) {
  const cur = currentRank(input);
  return {
    rank: cur,
    maxDanger: cur.maxDanger,
    shopTier: cur.shopTier,
    title: cur.name
  };
}
...
// 不要再把主線等級接回這道門。
function canAcceptDanger(input = 0, danger = 1) {
  return danger <= currentRank(input).maxDanger;
}

// 危險度被鎖住時，要多少聲望才解鎖（已解鎖 → null）
function repNeededForDanger(input = 0, danger = 1) {
