...
exports.CAT_CARD_MAP = exports.CAT_CARD_CATEGORIES = exports.CAT_CARDS = void 0;
exports.rollGacha = rollGacha;
// src/lib/catCardData.js
// 200張貓貓卡片資料（001-100 初版十分類 + 101-200 擴充十分類）。image欄位待GEMINI生成後填入URL。
const CAT_CARDS = exports.CAT_CARDS = [
// ── 1. 射箭貓 Archery ──────────────────────────────────────
{
  id: "001",
  name: "初心射手",
...
const CAT_CARD_MAP = exports.CAT_CARD_MAP = Object.fromEntries(CAT_CARDS.map(c => [c.id, c]));
const CAT_CARD_CATEGORIES = exports.CAT_CARD_CATEGORIES = {
  archery: {
    label: "射箭貓",
    emoji: "🏹"
  },
